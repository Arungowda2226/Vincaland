    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity onPress={handleLogout} style={styles.logoutBtn}>
          <Ionicons name="log-out-outline" size={22} color="#fff" style={{ marginRight: 6 }} />
...
const styles = StyleSheet.create({
  header: { padding: 20, alignItems: "center", borderBottomWidth: 1, borderColor: "#ddd", position: "relative", marginTop: 30 },
  profileImage: { width: 80, height: 80, borderRadius: 40, marginBottom: 10 },
  userName: { fontSize: 18, fontWeight: "bold" },
  userEmail: { fontSize: 14, color: "gray" },
  editIcon: { position: "absolute", top: 20, right: 20 },
  footer: { padding: 20, borderTopWidth: 1, borderColor: "#ddd", marginBottom: 30 },
  logoutBtn: { flexDirection: "row", backgroundColor: "red", padding: 12, borderRadius: 8, alignItems: "center", justifyContent: "center" },
